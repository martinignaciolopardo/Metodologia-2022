...
$r->addRoute("verifyPatient", "POST", "LoginController", "verifyPatient");
$r->addRoute("turnos/verDetalles/:ID", "GET", "TurnsController", "confirmarTurno");
$r->addRoute("turnos/confirmarTurno/:ID", "POST", "TurnsController", "mostrarDetalles");
